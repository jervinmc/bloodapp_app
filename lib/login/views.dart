            ...
            children: [
              Card(
                ...
                child: Container(
                  ...
                  child: Column(
                      children: <Widget>[
                        Image.asset("assets/logo_donate.jpeg",height: 200,),
                        Container(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            style: ButtonStyle(
                                backgroundColor: MaterialStateProperty.all<Color>(Color(0xffd00015)),
                        ...
                        Container(
                          ...
                          width: 250,
                          child: ElevatedButton(
                              child: Text('Sign up Donor/Finder',style: TextStyle(color: Colors.black),),
                            onPressed: () {
                          ...
                          width: 250,
                          child: ElevatedButton(
                              child: Text('Sign up as Institution',style: TextStyle(color: Colors.black),),
                            onPressed: () {
                              Get.toNamed('/registerInstitution');
                            },
                              style: ElevatedButton.styleFrom(
                                shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(18.0),
